---
name: tui-exploratory-tester
description: Start the app in a tmux session and perform exploratory testing around a task/story, actively trying to break things and find edge cases.
---
