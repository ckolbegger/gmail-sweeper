...
- **FR-003**: System MUST send email metadata (subject, sender, snippet) to a configurable AI service for relevance evaluation against the user's description
...
- The terminal UI is implemented with Ink + React TSX components in the `src/tui/` module
...
- Email data model must include at minimum: subject, sender, and snippet text
